  ...
  export default function Nav(){
    return (
      ...
      <div id="nav_container" className="bg-purple-700 p-3 flex justify-between items-center"> 
        {/* svg logo h1 rn */}
        <div className="flex">
        <img src="https://cdn2.iconfinder.com/data/icons/free-line-halloween-icons/24/Ghost-256.png"  className="sm:w-1/6 p-1 bg-green-300 shadow-2xl rounded" alt="Logo"/>
