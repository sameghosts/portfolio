...
export default function About(){
  ...
  <div id="About" className="p-2 flex flex-col bg-green-300 items-center">
    ...
    <div className="p-3 w-full flex justify-evenly items-stretch">
      ...
      <a className="text-xl inline-block p-4  bg-indigo-700 hover:bg-green-600 text-indigo-300  hover:text-green-200 shadow-2xl rounded transition ease-in duration-150" href="mailto:seanfeiner.brown@gmail.com">Email</a>
      </div>
