...
export default function Splash(){
  return (
    ...
    <div id="Splash" className="p-2 flex flex-col bg-gray-400 items-center w-auto">
      ...
      <a className="text-xl inline-block p-4  bg-indigo-700 hover:bg-green-600 text-indigo-300  hover:text-green-200 shadow-2xl rounded transition ease-in duration-150" target="_blank" href="https://drive.google.com/file/d/1zLlRdzdAzr9ZY9EsEI7xqKNq4JIUGeca/view?usp=sharing">Resume</a>
